    ...
    if isinstance(encoding, str):
        if encoding == 'ravdess':
            ...
            if str(files[0].name)[4] == "_":
                ...
                raise  DatasetError(f'Wrong separator in file names: {str(files[0].name)[4]} was given but - was expected.')
        else:
